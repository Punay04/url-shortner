...
export default function DashboardContent() {
  ...
  const statsItems = [
    { title: "URL's Generated", icon: <Link />, value: stats.totalUrls },
    { title: "Total Clicks", icon: <Mouse />, value: stats.totalClicks },
    { title: "Most Clicked", icon: <Activity />, value: stats.mostClicked },
  ];

  if (loading) {
    return <div className="ml-64 p-8 h-full bg-black">Loading...</div>;
  }
      ...
      >
        ...
        <div className="space-y-4">
          {urls.map((url, index) => (
            <div
              key={index}
              className="group flex items-center justify-between p-4 bg-black/40 
